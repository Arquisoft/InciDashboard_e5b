...
public class FilterTest {
	...
	@Autowired
	private DBManagementFacade dbManager;
    ...
    public void testRIncidenceP() {
	    ...
	    HashSet<Property> propertiesTest = new HashSet<>();
	    ...
	    propertiesTest.add(new Property("prop2", "val2"));
	    	...
	    	incidenceTest
			.setAgent(dbManager.getAgent("316683136", "1234", "Person"))
